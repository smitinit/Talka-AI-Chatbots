...
//               <div className="absolute inset-0 rounded-full bg-[conic-gradient(at_top_left,#6ee7b7_0deg,#a7f3d0_90deg,#6ee7b7_180deg,#a7f3d0_270deg)] blur-[120px] opacity-20" />
...
//         {/* Top-Right Soft Glow */}
//         <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_#d1fae5_0%,_transparent_60%)] opacity-30" />

//         {/* Bottom-Left Soft Glow */}
//         <div className="absolute bottom-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_bottom_left,_#a7f3d0_0%,_transparent_60%)] opacity-25" />
//       </div>
...
//       {/* CTA Section */}
//       <section className="relative py-16 md:py-24 overflow-hidden text-primary-foreground">
//         {/* Subtle Conic Gradient Background */}
//         <div className="absolute -top-[20%] left-1/2 -translate-x-1/2 h-[140%] w-[140%] rounded-full bg-[conic-gradient(at_center,_#6ee7b7_0deg,_#a7f3d0_90deg,_#6ee7b7_180deg,_#a7f3d0_270deg)] opacity-10 blur-[100px] pointer-events-none -z-10" />
