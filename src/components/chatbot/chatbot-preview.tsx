  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6  flex flex-col items-end z-[12341234]">
      ...
      <Button
        ...
        className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
        size="icon"
      >
        {isOpen ? (
